...
@Component
@Slf4j
public class AlterTableTask extends AbstractBaseTask {
    ...
    public List<String> buildCmd() {
        final String argFile = "/tmp/cmd_alter_" + System.currentTimeMillis() + ".arg";
        final String cmdFile = "/tmp/cmd_alter_" + System.currentTimeMillis() + ".sh";
